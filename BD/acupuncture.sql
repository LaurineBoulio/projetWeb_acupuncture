...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 30 sep. 2021 à 13:58
...
CREATE TABLE IF NOT EXISTS `inscription` (
  ...
  `pseudo` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `telephone` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `keywords` (
  ...
  `name` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'mot clef',
  PRIMARY KEY (`idK`)
...
CREATE TABLE IF NOT EXISTS `meridien` (
  `code` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'code du méridien',
  `nom` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'nom',
  `element` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'élément',
...
CREATE TABLE IF NOT EXISTS `patho` (
  ...
  `mer` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'code du méridien',
  `type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `desc` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'description de la pathologie',
  PRIMARY KEY (`idP`),
  KEY `code` (`mer`)
...
CREATE TABLE IF NOT EXISTS `symptome` (
  ...
  `desc` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'description du symptôme',
  PRIMARY KEY (`idS`)
