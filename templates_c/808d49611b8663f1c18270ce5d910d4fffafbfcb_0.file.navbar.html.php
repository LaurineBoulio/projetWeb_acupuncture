<?php
/* Smarty version 3.1.39, created on 2021-11-11 18:20:28
  from 'D:\wamp64\www\projetWeb_acupuncture\sharedfile\navbar.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_618d5eeca08bd4_62522788',
...
function content_618d5eeca08bd4_62522788 (Smarty_Internal_Template $_smarty_tpl) {
		...
		<div class="collapse navbar-collapse" id="main-menu">
		   <ul class="nav navbar-nav navbar-right">
			...
			<?php if ((isset($_SESSION['pseudo']))) {?>	
				...
				<li><a href="./index.php?action=getDeco">Profil : <?php echo $_SESSION['pseudo'];?>
 <br>Se déconnecter</a></li>
			<?php } else { ?>	
